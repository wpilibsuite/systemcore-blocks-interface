...
export function customTokens(t: (key: string) => string): typeof Blockly.Msg {
  return {
    ...
    LINE: t('BLOCKLY.LINE'),
    DISPLAY_ADD_DATA_TITLE: t('BLOCKLY.DISPLAY_ADD_DATA_TITLE'),
    DISPLAY_ADD_LINE_TITLE: t('BLOCKLY.DISPLAY_ADD_LINE_TITLE'),
    DISPLAY_ADD_DATA_TOOLTIP: t('BLOCKLY.TOOLTIP.DISPLAY_ADD_DATA'),
    DISPLAY_ADD_LINE_TOOLTIP: t('BLOCKLY.TOOLTIP.DISPLAY_ADD_LINE'),
