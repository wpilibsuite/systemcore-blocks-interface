...
export function customTokens(t: (key: string) => string): typeof Blockly.Msg {
  return {
    ...
    DISPLAY_DESCRIPTION: t('BLOCKLY.DISPLAY_DESCRIPTION'),
    NO_MECHANISM_CONTENTS: t('BLOCKLY.NO_MECHANISM_CONTENTS'),
    NO_ROBOT_CONTENTS: t('BLOCKLY.NO_ROBOT_CONTENTS'),
    ...
    OPMODE_DESCRIPTION_TOOLTIP: t('BLOCKLY.TOOLTIP.OPMODE_DESCRIPTION'),
    CALL: t('BLOCKLY.CALL'),
    ...
    WARNING_FIRE_EVENT_MISSING_EVENT: t('BLOCKLY.WARNING.FIRE_EVENT_MISSING_EVENT'),
    ...
    WARNING_DUPLICATE_PORT: t('BLOCKLY.WARNING.DUPLICATE_PORT'),
    ...
    MORE_BLOCKS_LABEL: t('BLOCKLY.MORE_BLOCKS_LABEL'),
    ...
    MECHANISM_COMPONENT_REFERENCE_TOOLTIP: t('BLOCKLY.TOOLTIP.MECHANISM_COMPONENT_REFERENCE'),
    COMPONENT_REFERENCE_TOOLTIP: t('BLOCKLY.TOOLTIP.COMPONENT_REFERENCE'),
    WARNING_COMPONENT_REFERENCE_PRIVATE_COMPONENT: t('BLOCKLY.WARNING.COMPONENT_REFERENCE_PRIVATE_COMPONENT'),
    WARNING_COMPONENT_REFERENCE_MISSING_COMPONENT: t('BLOCKLY.WARNING.COMPONENT_REFERENCE_MISSING_COMPONENT'),
    WARNING_COMPONENT_REFERENCE_MISSING_MECHANISM: t('BLOCKLY.WARNING.COMPONENT_REFERENCE_MISSING_MECHANISM'),
  }
};
