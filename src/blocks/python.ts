...
// Variables and functions used in block with drop down fields (variables and enums).
...
export function initializeModuleVariableGetter(moduleName, varType, varNames, tooltips) {
  const key = 'module ' + moduleName + ' ' + varType;
...
export function initializeEnum(enumClassName, enumValues, tooltips) {
...
pythonGenerator.forBlock['get_python_module_variable'] = function(block: any, generator) {
...
pythonGenerator.forBlock['get_python_class_variable'] = function(block: any, generator) {
...
pythonGenerator.forBlock['get_python_instance_variable'] = function(block: any, generator) {
...
pythonGenerator.forBlock['set_python_module_variable'] = function(block: any, generator) {
  const moduleName = block.getFieldValue(pythonUtils.FIELD_MODULE_NAME);
  const varName = (block.firstAttributes_.actualVariableName)
      ? block.firstAttributes_.actualVariableName : block.getFieldValue(pythonUtils.FIELD_VARIABLE_NAME);
...
pythonGenerator.forBlock['set_python_class_variable'] = function(block: any, generator) {
  const className = block.getFieldValue(pythonUtils.FIELD_CLASS_NAME);
  const varName = (block.firstAttributes_.actualVariableName)
      ? block.firstAttributes_.actualVariableName : block.getFieldValue(pythonUtils.FIELD_VARIABLE_NAME);
  const value = generator.valueToCode(block, 'VALUE', Order.NONE);
...
pythonGenerator.forBlock['set_python_instance_variable'] = function(block: any, generator) {
  const selfValue = generator.valueToCode(block, 'SELF', Order.MEMBER);
  const varName = (block.firstAttributes_.actualVariableName)
      ? block.firstAttributes_.actualVariableName : block.getFieldValue(pythonUtils.FIELD_VARIABLE_NAME);
  const value = generator.valueToCode(block, 'VALUE', Order.NONE);
...
pythonGenerator.forBlock['call_python_module_function'] = function(block: any, generator) {
  const moduleName = block.getFieldValue(pythonUtils.FIELD_MODULE_NAME);
...
pythonGenerator.forBlock['call_python_static_method'] = function(block: any, generator) {
  const className = block.getFieldValue(pythonUtils.FIELD_CLASS_NAME);
  const functionName = (block.firstAttributes_.actualFunctionName)
      ? block.firstAttributes_.actualFunctionName : block.getFieldValue(pythonUtils.FIELD_FUNCTION_NAME);
  if (block.firstAttributes_.importModule) {
...
pythonGenerator.forBlock['call_python_constructor'] = function(block: any, generator) {
  const className = block.getFieldValue(pythonUtils.FIELD_CLASS_NAME);
  if (block.firstAttributes_.importModule) {
    (generator as any).definitions_['import_' + block.firstAttributes_.importModule] =
        'import ' + block.firstAttributes_.importModule;
...
pythonGenerator.forBlock['call_python_instance_method'] = function(block: any, generator) {
...
pythonGenerator.forBlock['get_python_enum_value'] = function(block: any, generator) {
