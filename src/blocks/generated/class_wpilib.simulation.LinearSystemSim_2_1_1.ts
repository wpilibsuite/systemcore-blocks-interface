...
// Blocks for class wpilib.simulation.LinearSystemSim_2_1_1
...
export function getToolboxCategory(subcategories: any): Category {
  const category = {
    kind: "category",
    name: "LinearSystemSim_2_1_1",
    contents: [
      {"kind": "block", "type": "variables_set", "fields": {"VAR": {"name": "myLinearSystemSim_2_1_1"}}, "inputs": {"VALUE": {"block": {"kind": "block", "type": "call_python_constructor", "extraState": {"tooltip": "Creates a simulated generic linear system.\n\n:param system:             The system to simulate.\n:param measurementStdDevs: The standard deviations of the measurements.", "returnType": "wpilib.simulation._simulation.LinearSystemSim_2_1_1", "args": [{"name": "system", "type": "wpimath._controls._controls.system.LinearSystem_2_1_1"}, {"name": "measurementStdDevs", "type": "Annotated[list[float], FixedSize(1)]"}], "importModule": "wpilib.simulation"}, "fields": {"CLASS": "wpilib.simulation.LinearSystemSim_2_1_1"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myLinearSystem_2_1_1"}}}}}}}}},
      {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Returns the current drawn by this simulated system. Override this method to\nadd a custom current calculation.\n\n:returns: The current drawn by this simulated mechanism.", "returnType": "wpimath.units.amperes", "args": [{"name": "linearSystemSim_2_1_1", "type": "wpilib.simulation._simulation.LinearSystemSim_2_1_1"}], "importModule": ""}, "fields": {"CLASS": "wpilib.simulation.LinearSystemSim_2_1_1", "FUNC": "getCurrentDraw"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myLinearSystemSim_2_1_1"}}}}}},
      ...
      {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Sets the system state.\n\n:param state: The new state.", "returnType": "None", "args": [{"name": "linearSystemSim_2_1_1", "type": "wpilib.simulation._simulation.LinearSystemSim_2_1_1"}, {"name": "state", "type": "numpy.ndarray[numpy.float64[2, 1]]"}], "importModule": ""}, "fields": {"CLASS": "wpilib.simulation.LinearSystemSim_2_1_1", "FUNC": "setState"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myLinearSystemSim_2_1_1"}}}}, "ARG1": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myfloat64[2, 1]]"}}}}}},
