...
export function getToolboxCategory(subcategories: any): Category {
  const category = {
    ...
    contents: [
      ...
      {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Change the handler function.\n\n:param handler: Handler", "returnType": "None", "args": [{"name": "notifier", "type": "wpilib._wpilib.Notifier"}, {"name": "handler", "type": "Callable[[], None]"}], "importModule": ""}, "fields": {"CLASS": "wpilib.Notifier", "FUNC": "setCallback"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myNotifier"}}}}}},
