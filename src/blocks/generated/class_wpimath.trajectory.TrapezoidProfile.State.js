...
python.PythonVariableGetterNames["instance wpimath.trajectory.TrapezoidProfile.State float"] = ["position"];
python.PythonVariableGetterTooltips["instance wpimath.trajectory.TrapezoidProfile.State float"] = ["The position at this state."];
python.PythonVariableGetterNames["instance wpimath.trajectory.TrapezoidProfile.State wpimath.units.units_per_second"] = ["velocity"];
python.PythonVariableGetterTooltips["instance wpimath.trajectory.TrapezoidProfile.State wpimath.units.units_per_second"] = ["The velocity at this state."];
