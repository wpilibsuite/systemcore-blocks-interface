...
export function getToolboxCategory(subcategories: Category[] = []): Category {
  const category: Category = {
    ...
    contents: [
      ...
      {"kind": "block", "type": "variables_set", "fields": {"VAR": {"name": "myControlVector"}}, "inputs": {"VALUE": {"block": {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Returns the final control vector that created this spline.\n\n:returns: The final control vector that created this spline.", "returnType": "wpimath.spline._spline.Spline5.ControlVector", "args": [{"name": "quinticHermiteSpline", "type": "wpimath.spline._spline.QuinticHermiteSpline"}], "importModule": ""}, "fields": {"CLASS": "wpimath.spline.QuinticHermiteSpline", "FUNC": "getFinalControlVector"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myQuinticHermiteSpline"}}}}}}}}},
      {"kind": "block", "type": "variables_set", "fields": {"VAR": {"name": "myControlVector"}}, "inputs": {"VALUE": {"block": {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Returns the initial control vector that created this spline.\n\n:returns: The initial control vector that created this spline.", "returnType": "wpimath.spline._spline.Spline5.ControlVector", "args": [{"name": "quinticHermiteSpline", "type": "wpimath.spline._spline.QuinticHermiteSpline"}], "importModule": ""}, "fields": {"CLASS": "wpimath.spline.QuinticHermiteSpline", "FUNC": "getInitialControlVector"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myQuinticHermiteSpline"}}}}}}}}},
