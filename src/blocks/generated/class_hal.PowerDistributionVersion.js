...
python.PythonVariableGetterNames["instance hal.PowerDistributionVersion int"] = ["firmwareFix", "firmwareMajor", "firmwareMinor", "hardwareMajor", "hardwareMinor", "uniqueId"];
python.PythonVariableGetterTooltips["instance hal.PowerDistributionVersion int"] = ["Firmware fix version number.", "Firmware major version number.", "Firmware minor version number.", "Hardware major version number.", "Hardware minor version number.", "Unique ID."];
python.PythonVariableSetterNames["instance hal.PowerDistributionVersion int"] = ["firmwareFix", "firmwareMajor", "firmwareMinor", "hardwareMajor", "hardwareMinor", "uniqueId"];
