...
python.PythonVariableGetterNames["instance wpimath.trajectory.ExponentialProfileMeterVolts.Constraints wpimath.units.units_per_second"] = ["A"];
python.PythonVariableGetterTooltips["instance wpimath.trajectory.ExponentialProfileMeterVolts.Constraints wpimath.units.units_per_second"] = ["The State-Space 1x1 system matrix."];
python.PythonVariableGetterNames["instance wpimath.trajectory.ExponentialProfileMeterVolts.Constraints wpimath.units.meters_per_second_squared_per_volt"] = ["B"];
python.PythonVariableGetterTooltips["instance wpimath.trajectory.ExponentialProfileMeterVolts.Constraints wpimath.units.meters_per_second_squared_per_volt"] = ["The State-Space 1x1 input matrix."];
python.PythonVariableGetterNames["instance wpimath.trajectory.ExponentialProfileMeterVolts.Constraints wpimath.units.volts"] = ["maxInput"];
