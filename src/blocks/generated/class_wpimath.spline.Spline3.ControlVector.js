...
python.PythonVariableGetterNames["instance wpimath.spline.Spline3.ControlVector Tuple[float, float]"] = ["x", "y"];
python.PythonVariableGetterTooltips["instance wpimath.spline.Spline3.ControlVector Tuple[float, float]"] = ["The x components of the control vector.", "The y components of the control vector."];
python.PythonVariableSetterNames["instance wpimath.spline.Spline3.ControlVector Tuple[float, float]"] = ["x", "y"];
python.PythonVariableSetterTooltips["instance wpimath.spline.Spline3.ControlVector Tuple[float, float]"] = ["The x components of the control vector.", "The y components of the control vector."];
