...
python.PythonVariableGetterNames["instance hal.ControlWord int"] = ["autonomous", "control_reserved", "dsAttached", "eStop", "enabled", "fmsAttached", "test"];
python.PythonVariableGetterTooltips["instance hal.ControlWord int"] = ["", "", "", "", "", "", ""];
python.PythonVariableSetterNames["instance hal.ControlWord int"] = ["autonomous", "control_reserved", "dsAttached", "eStop", "enabled", "fmsAttached", "test"];
python.PythonVariableSetterTooltips["instance hal.ControlWord int"] = ["", "", "", "", "", "", ""];
