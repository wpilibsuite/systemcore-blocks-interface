...
python.PythonVariableGetterNames["instance wpimath.kinematics.MecanumDriveWheelPositions wpimath.units.meters"] = ["frontLeft", "frontRight", "rearLeft", "rearRight"];
python.PythonVariableGetterTooltips["instance wpimath.kinematics.MecanumDriveWheelPositions wpimath.units.meters"] = ["Distance driven by the front-left wheel.", "Distance driven by the front-right wheel.", "Distance driven by the rear-left wheel.", "Distance driven by the rear-right wheel."];
python.PythonVariableSetterNames["instance wpimath.kinematics.MecanumDriveWheelPositions wpimath.units.meters"] = ["frontLeft", "frontRight", "rearLeft", "rearRight"];
