...
export function getToolboxCategory(subcategories: Category[] = []): Category {
  const category: Category = {
    ...
    contents: [
      ...
      {"kind": "block", "type": "variables_set", "fields": {"VAR": {"name": "myRectangularRegionConstraint"}}, "inputs": {"VALUE": {"block": {"kind": "block", "type": "call_python_constructor", "extraState": {"tooltip": "Constructs a new RectangularRegionConstraint.\n\n:param rectangle:  The rectangular region in which to enforce the constraint.\n:param constraint: The constraint to enforce when the robot is within the\n                   region.", "returnType": "wpimath._controls._controls.constraint.RectangularRegionConstraint", "args": [{"name": "rectangle", "type": "wpimath.geometry._geometry.Rectangle2d"}, {"name": "constraint", "type": "wpimath._controls._controls.constraint.TrajectoryConstraint"}], "importModule": "wpimath.trajectory.constraint"}, "fields": {"CLASS": "wpimath.trajectory.constraint.RectangularRegionConstraint"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myRectangle2d"}}}}, "ARG1": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myTrajectoryConstraint"}}}}}}}}},
