...
python.PythonVariableGetterNames["instance hal.JoystickDescriptor int"] = ["axisCount", "buttonCount", "isXbox", "povCount", "type"];
python.PythonVariableGetterTooltips["instance hal.JoystickDescriptor int"] = ["", "", "", "", ""];
python.PythonVariableSetterNames["instance hal.JoystickDescriptor int"] = ["axisCount", "buttonCount", "isXbox", "povCount", "type"];
python.PythonVariableSetterTooltips["instance hal.JoystickDescriptor int"] = ["", "", "", "", ""];
python.PythonVariableGetterNames["instance hal.JoystickDescriptor memoryview"] = ["axisTypes", "name"];
python.PythonVariableGetterTooltips["instance hal.JoystickDescriptor memoryview"] = ["", ""];
