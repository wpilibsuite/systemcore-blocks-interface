...
export function getToolboxCategory(subcategories: any): Category {
  const category = {
    ...
    name: "MotorSafety",
    contents: [
      {"kind": "block", "type": "variables_set", "fields": {"VAR": {"name": "myMotorSafety"}}, "inputs": {"VALUE": {"block": {"kind": "block", "type": "call_python_constructor", "extraState": {"tooltip": "", "returnType": "wpilib._wpilib.MotorSafety", "args": [], "importModule": "wpilib"}, "fields": {"CLASS": "wpilib.MotorSafety"}}}}},
      ...
      {"kind": "block", "type": "call_python_instance_method", "extraState": {"tooltip": "Returns a description to print when an error occurs.\n\n:returns: Description to print when an error occurs.", "returnType": "str", "args": [{"name": "motorSafety", "type": "wpilib._wpilib.MotorSafety"}], "importModule": ""}, "fields": {"CLASS": "wpilib.MotorSafety", "FUNC": "getDescription"}, "inputs": {"ARG0": {"block": {"type": "variables_get", "fields": {"VAR": {"name": "myMotorSafety"}}}}}},
