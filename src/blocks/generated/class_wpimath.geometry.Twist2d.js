...
python.PythonVariableGetterNames["instance wpimath.geometry.Twist2d wpimath.units.radians"] = ["dtheta"];
python.PythonVariableGetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.radians"] = ["Angular \"dtheta\" component (radians)"];
python.PythonVariableSetterNames["instance wpimath.geometry.Twist2d wpimath.units.radians"] = ["dtheta"];
python.PythonVariableSetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.radians"] = ["Angular \"dtheta\" component (radians)"];
python.PythonVariableGetterNames["instance wpimath.geometry.Twist2d wpimath.units.degrees"] = ["dtheta_degrees"];
python.PythonVariableGetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.degrees"] = [""];
python.PythonVariableSetterNames["instance wpimath.geometry.Twist2d wpimath.units.degrees"] = ["dtheta_degrees"];
python.PythonVariableSetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.degrees"] = [""];
python.PythonVariableGetterNames["instance wpimath.geometry.Twist2d wpimath.units.meters"] = ["dx", "dy"];
python.PythonVariableGetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.meters"] = ["Linear \"dx\" component", "Linear \"dy\" component"];
python.PythonVariableSetterNames["instance wpimath.geometry.Twist2d wpimath.units.meters"] = ["dx", "dy"];
python.PythonVariableSetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.meters"] = ["Linear \"dx\" component", "Linear \"dy\" component"];
python.PythonVariableGetterNames["instance wpimath.geometry.Twist2d wpimath.units.feet"] = ["dx_feet", "dy_feet"];
python.PythonVariableGetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.feet"] = ["", ""];
python.PythonVariableSetterNames["instance wpimath.geometry.Twist2d wpimath.units.feet"] = ["dx_feet", "dy_feet"];
python.PythonVariableSetterTooltips["instance wpimath.geometry.Twist2d wpimath.units.feet"] = ["", ""];
