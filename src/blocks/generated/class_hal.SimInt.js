...
python.PythonVariableGetterNames["instance hal.SimInt hal._wpiHal.Type"] = ["type"];
python.PythonVariableGetterTooltips["instance hal.SimInt hal._wpiHal.Type"] = [""];
python.PythonVariableGetterNames["instance hal.SimInt int"] = ["value"];
python.PythonVariableGetterTooltips["instance hal.SimInt int"] = [""];
python.PythonVariableSetterNames["instance hal.SimInt int"] = ["value"];
python.PythonVariableSetterTooltips["instance hal.SimInt int"] = [""];
